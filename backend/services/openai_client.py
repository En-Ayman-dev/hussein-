...
class OpenAIClient:
    ...
    SYSTEM_PROMPT = (
        ...
        "8. لا تكرر حقول القاعدة بصيغة جامدة أو مدرسية مثل نسخ عناوين: التعريف، الإجراءات، المصطلحات، إلا إذا طلب المستخدم ذلك. المطلوب جواب حي يجيب عن السؤال فعلاً.\n"
        "9. إذا كان السياق غنياً، فلا تكتف بإعادة أول تعريف فقط، بل وسع الجواب بالاقتباس والعلاقات والموقف العملي المتاح في السياق.\n"
        "10. تجنب الزخرفة الأدبية والعبارات الحديثة المحايدة. المطلوب خطاب حي وواضح ومسؤول.\n\n"
        ...
        "8. أجب عن كل جزء في سؤال المستخدم بوضوح. إذا سأل: ما هو X وكيف نعمل به؟ فعرّف X أولاً ثم انتقل إلى كيفية العمل به، ولا تترك أحد الشقين."
    )
